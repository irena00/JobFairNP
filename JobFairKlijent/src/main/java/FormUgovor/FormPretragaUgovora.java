...
import domen.Ugovor;
import models.TableModelUgovori;

/**
 *
 * @author PC
 */
public class FormPretragaUgovora extends javax.swing.JDialog {

    public FormPretragaUgovora(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
        setLocationRelativeTo(null);
        TableModelUgovori model = new TableModelUgovori();
    ...
    private void initComponents() {
        ...
        btnDetalji.setText("Detalji ugovora");
    ...
    private void txtPretragaKeyReleased(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_txtPretragaKeyReleased
        ...
        ((TableModelUgovori) tblUgovori.getModel()).setParametar(param);
    ...
    private void btnDetaljiActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnDetaljiActionPerformed
        ...
        if (row >= 0) {
            Ugovor u = ((TableModelUgovori) tblUgovori.getModel()).getSelectedUgovor(row);
            new FormDetaljiUgovora(this, rootPaneCheckingEnabled, u).setVisible(true);
        }
    ...
    void refreshTable() {
        TableModelUgovori tm = (TableModelUgovori) tblUgovori.getModel();
        tm.refreshTable();
    }
